...
ShaderComponent * ShaderComponent::genDefaultShader()
{
	...
	Shader* default_vertex_shader = Loader::loadShader(default_vertex_loc, Shader::VERTEX_SHADER);
	Shader* default_fragment_shader = Loader::loadShader(default_fragment_loc, Shader::FRAGMENT_SHADER);
